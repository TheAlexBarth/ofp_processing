# This utilities are for processing this particle data
# However they are being written generally with the possibility of adding
# then to ecotaxatools one day.
...
numeric_spectra <- function(df, 
  ...
  df$n_s <- (df$count / (vol_cm3) / df$size_width)
...
#' @param log if log method, the base of the log
